/**
 * Executive summary components for high-level dashboard view.
 */
...
export { mockExecutiveData, fetchExecutiveData, type ExecutiveData } from './mockData';

// Re-export SegmentPerformanceChart from visualizations for convenience
export { SegmentPerformanceChart } from '@/components/visualizations';
