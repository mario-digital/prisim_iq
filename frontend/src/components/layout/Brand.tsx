 ...
 * Features a glowing gem icon with gradient text for both light and dark themes.
 */
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-cyan-500/30 dark:bg-cyan-400/30 blur-lg rounded-full" />
        <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 dark:from-cyan-400 dark:to-blue-500 shadow-lg shadow-cyan-500/30 dark:shadow-cyan-500/25">
